Shader "Examples/VFPlasma"
{
	Properties {
      _Tint("Colour Tint", Color) = (1,1,1,1)
      _Speed("Speed", Range(1,100)) = 10
      _Scale1("Scale 1", Range(0.1,100)) = 20
      _Scale2("Scale 2", Range(0.1,100)) = 20
      _Scale3("Scale 3", Range(0.1,100)) = 20
      _Scale4("Scale 4", Range(0.1,100)) = 20
    }
	SubShader
	{
		...
		Pass
		{
			...
			fixed4 frag (v2f i) : SV_Target
			{
	            ...
	            //sin to use
	            float xpos = i.vertex.x * 0.0001;
	            float ypos = i.vertex.y * 0.0001;
